...
#define COLOR_ON   matrix->color565(255, 0, 128)  // Pink for active segments
#define COLOR_COLON matrix->color565(220, 0, 110) // Slightly dimmer pink colon

// Original green colors (commented out)
